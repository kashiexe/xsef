...
> ![WARNING]
> Disclaimer!
> This project in specific was made for educational purposes so there won't be much expansion on THIS repo, I am planning, however, to make more emulators in the future, since this was very fun to make and surprisingly quick (only around 10 hours of active coding and debugging).
> There are, however, still some issues lingering around that I need to fix, as well as TUI expansions regarding state updating (for the CHIP8 instance) and logging
